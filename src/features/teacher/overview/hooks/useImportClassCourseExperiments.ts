import { postApiExcelImportClassCourseExperiments } from "@/core/api/generated"
 ...
 * Excel批量导入班级课程实验
 */
export function useImportClassCourseExperiments() {
  return useMutation({
    mutationFn: async (file: File) => {
      const response = await postApiExcelImportClassCourseExperiments({
        body: { file },
        client,
      })
