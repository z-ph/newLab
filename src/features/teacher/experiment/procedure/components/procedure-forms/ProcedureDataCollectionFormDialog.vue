<template>
  <Dialog v-model:visible="visible" header="添加数据收集步骤" :style="{ width: '60vw' }" :modal="true">
...
import { formatDateToISO, parseJson, parseArray } from '@/features/teacher/experiment/procedure/utils'
